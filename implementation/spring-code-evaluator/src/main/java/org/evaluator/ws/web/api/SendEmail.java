...
public class SendEmail {
    ...
    public void send(String to, String subject, String username, String password) throws MessagingException {
        ...
        helper.setText("<style type=\"text/css\">\n" +
                ...
                "  </tr>\n" +
                "  <tr>\n" +
                "    <td class=\"tg-baqh\" colspan=\"5\"><br/><br/><br/><br/><br/>For more info about Assistant Code Evaluator <br/> contact our administrator at <br/><br/> assistantcodevaluator@gmail.com</td>\n" +
                "  </tr>\n" +
                "</table>", true);
